...
// Detect if this window is for setup (passed as query param)
    ...
    return (
      <div className="flex flex-col w-full h-full relative overflow-hidden"
        ...
        <div className="absolute inset-x-0 top-0 h-px"
          style={{ background: 'linear-gradient(90deg,transparent,rgba(124,58,237,.6),transparent)' }} />
        <SetupWizard />
      </div>
    )
  }
  ...
  return (
    <div className="flex flex-col w-full h-full relative overflow-hidden"
      ...
      <div className="absolute inset-x-0 bottom-0 h-px"
        style={{ background: 'linear-gradient(90deg,transparent,rgba(124,58,237,.3),transparent)' }} />
    </div>
  )
}